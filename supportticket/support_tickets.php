...
<head>
    ...
    <title>support tickets - Bootdey.com</title>
		...
		<div class="col-md-9">
			<div class="grid support-content">
				 <div class="grid-body">
					...
					<!-- BEGIN NEW TICKET -->
					<button type="button" class="btn btn-success pull-middle" data-toggle="modal" data-target="#newIssue">New Issue</button>
									...
									<form action="#" method="POST">
										<div class="modal-body">
											<div class="form-group">
												<input name="number" type="number" class="form-control" placeholder="Enter Your Number">
											</div>
											<div class="form-group">
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn btn-primary pull-right" name="submit"><i class="fa fa-pencil"></i> Create</button>
										</div>
									</form>
								</div>
							</div>
					...
					<div class="row">
						...
						<button type="button" class="btn btn-primary pull-middle" data-toggle="modal" data-target="#Issue">My Tickets</button>
							...
							<div class="modal-wrapper">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header bg-blue">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
										<h4 class="modal-title"><i class="fa fa-pencil"></i> My Tickets</h4>
									</div>
									<form action="#" method="post">
										<div class="modal-body">
											<div class="row">
...
if(isset($_POST['submit'])){
	...
	$sql="INSERT INTO `ticket`(`number`, `email`, `subject`, `department`, `message`,) VALUES ('$number','$email','$subject','$department','$message')";
