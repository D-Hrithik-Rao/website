...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center mt-5">
      <div class="col-lg-6">
        <!-- form starts here -->
        <h1>SSIZ INTERNATIONAL PVT LTD</h1>
        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="bg-light p-4 shadow-sm" method="post" novalidate>
          <div class="row gy-3">
            ...
            <div class="col-lg-6">
              ...
              <option value="Billing" <?= (isset($gender) && $gender == "Billing") ? "selected" : ""; ?>>Billing</option>
               <option value="Printing" <?= (isset($gender) && $gender == "Printing") ? "selected" : ""; ?>>Printing</option> 
               <option value="Installation" <?= (isset($gender) && $gender == "Installation") ? "selected" : ""; ?>>Installation</option> 
               <option value="Hardware Issues" <?= (isset($gender) && $gender == "Hardware Issues") ? "selected" : ""; ?>>Hardware Issues</option> 
               <option value="import/export" <?= (isset($gender) && $gender == "import/export") ? "selected" : ""; ?>>import/export</option>
                <option value="Reports" <?= (isset($gender) && $gender == "Reports") ? "selected" : ""; ?>>Reports</option> 
                <option value="Database Corruption" <?= (isset($gender) && $gender == "Database Corruption") ? "selected" : ""; ?>>Database Corruption</option> 
                <option value="Others" <?= (isset($gender) && $gender == "Others") ? "selected" : ""; ?>>Others</option>
              </select>
