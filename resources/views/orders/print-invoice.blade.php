                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                {{ Number::currency($item->unitcost, 'INR') }}
                                            </td>
                                            <td class="align-middle text-center">
                                                {{ $item->quantity }}
                                            </td>
                                            <td class="align-middle text-center">
                                                {{ Number::currency($item->total, 'INR') }}
                                            </td>
                                        </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <strong>
                                                    {{ Number::currency($order->sub_total, 'INR') }}
                                                </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <strong>
                                                    {{ Number::currency($order->total, 'INR') }}
                                                </strong>
                                            </td>
                                        </tr>
                                    </tbody>
